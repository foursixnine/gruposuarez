   ...
   $(function () {
    $('#containertablero').highcharts({
        ...
        series: [{
            name: '30',
   // data: [5]
            data: [0, 0, 0, 0, 0,0, total30,total30p, 0, 0,0,0]
        }, {
            name: '60',
        //    data: [5]
            data: [0, 0, 0, 0, 0,0, total60,total60p, 0, 0,0,0]
        }, {
            name: '90',
         //   data: [5]
            data: [0, 0, 0, 0, 0,0, total90,total90p, 0, 0,0,0]
        },{
            name: '120',
         //   data: [5]
            data: [0, 0, 0, 0, 0,0, total120,total120p, 0, 0,0,0]
        }]
    });
});
