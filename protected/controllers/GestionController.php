...
public function actionCreate($id){
    ...
    public function actionMorosidadProyecto(){
        ...
        $proyectomorosos =  Yii::app()->db->createCommand()
		 ...
		 AND (
		 (cartera_corriente > '."'0.00'".'  )  OR  
		 (cartera_30_dias > '."'0.00'".'  ) OR 
		 (cartera_60_dias > '."'0.00'".' ) OR
		 (cartera_90_dias > '."'0.00'".'  ) OR 
		 (cartera_120_dias > '."'0.00'".' ) OR  
		 (total_vencido > '."'0.00'".' ) ) GROUP BY proyecto')
                                ->queryAll(true);
