...
*/
  ...
  public function actionReportePasos(){
      ...
      $reportepasos = Yii::app()->db->createCommand()
      ->select('c.monto_liquidacion as totalliquidado, c.id_proyecto as idproyecto,c.total_venta as totalventa, c.nombre_de_empresa,c.numero_de_lote as lote, c.id_proyecto as crmproyecto,t.fecha_paso as fechaliquidacion,
      ...
      group by t.id_pasos, mes, crmproyecto, idproyecto,fechafin, c.proyecto,totalliquidado, totalventa,lote, c.nombre_de_empresa, fechaliquidacion 
