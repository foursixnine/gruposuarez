...
public function accessRules()
{
        ...
        array('allow', // allow admin user to perform 'admin' and 'delete' actions
           ...
           // 'users'=>array('*'),
            'users'=>array('admin', 'gilarreta','lvelasco','mguerra','orodriguez'),
        ),
...
*/
  ...
  public function actionReportePasos(){
      ...
      $reportepasos = Yii::app()->db->createCommand()
      ->select('c.monto_liquidacion as totalliquidado, c.vendedor as vendedor, c.agente_tramite as tramitador,c.id_proyecto as idproyecto,c.total_venta as totalventa, c.nombre_de_empresa,c.numero_de_lote as lote, c.id_proyecto as crmproyecto,t.fecha_paso as fechaliquidacion,
              c.proyecto as titulo, t.id_pasos, t.fecha_fin as fechafin, date_part('. "'month'".', t.fecha_fin) as mes')
      ->from('tramite t, cliente c')
      ->where('t.id_pasos=11 AND fecha_fin IS NOT NULL AND 
           c.id_cliente_gs=t.id_cliente_gs 
      group by t.id_pasos, mes, vendedor, tramitador,crmproyecto, idproyecto,fechafin, c.proyecto,totalliquidado, totalventa,lote, c.nombre_de_empresa, fechaliquidacion 
